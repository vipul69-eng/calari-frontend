    ...
    <LegalLayout title="Terms and Conditions" lastUpdated="January 2025">
      <div className="space-y-8">
        <section>
          ...
          <p className="mb-4">
            By accessing and using Calari ("the App"), you accept and agree to
        ...
        <section>
          ...
          <p className="mb-4">
            Calari is a mobile application that provides calorie counting and
            nutritional analysis services using artificial intelligence and
            image recognition technology. The service includes:
          </p>
        ...
        <section>
          ...
          <p className="mb-4">
            By using Calari, you acknowledge and agree that:
          </p>
          <ul className="list-disc pl-6 mb-4 space-y-2">
            <li>Your images and text data will be processed by AI systems</li>
            <li>
              AI analysis may not be 100% accurate and should not replace
              professional medical advice
            </li>
            <li>
              We use third-party AI services that may process your data
              according to their terms
            </li>
            <li>
              Nutritional information is provided for informational purposes
              only
            </li>
            <li>
              You should consult healthcare professionals for dietary and
              medical advice
            </li>
          </ul>
        </section>
        ...
        <section>
          ...
          <ul className="list-disc pl-6 mb-4 space-y-2">
            <li>
              The app and its original content are owned by Calari and protected
              by copyright laws
            </li>
            <li>You retain ownership of images and content you upload</li>
            <li>
              By uploading content, you grant us a license to use it for service
              provision
            </li>
            <li>
        ...
        <section>
          ...
          <div className="bg-yellow-50 border border-yellow-200 p-4 rounded-lg mb-4">
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>
                Calari is not a medical device and should not be used for
                medical diagnosis
              </li>
              <li>
                Nutritional information is estimated and may not be completely
                accurate
              </li>
              <li>
                Always consult healthcare professionals for dietary and medical
                advice
              </li>
              <li>
                Do not rely solely on the app for managing medical conditions
              </li>
              <li>
                Individual nutritional needs vary and require professional
                assessment
              </li>
            </ul>
          </div>
        ...
        <section>
          ...
          <p className="mb-4">
            To the fullest extent permitted by law, Calari shall not be liable
        ...
        <section>
          ...
          <ul className="list-disc pl-6 mb-4 space-y-2">
            ...
            <li>
              We will provide reasonable notice of significant changes when
              possible
            </li>
            <li>
              AI processing times may vary based on system load and complexity
            </li>
          </ul>
        </section>

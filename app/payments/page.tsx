        ...
        return (
          <div className="text-center space-y-6">
            ...
            <div className="space-y-2">
              <h2 className="text-2xl font-heading text-foreground">Verifying Payment</h2>
        ...
        return (
          <div className="text-center space-y-6">
            ...
            <div className="space-y-3">
              <h2 className="text-2xl font-heading text-foreground">Payment Successful!</h2>
            ...
            <div className="bg-green-50 border border-green-200 rounded-lg p-4 space-y-2">
              ...
              <p className="text-sm text-green-600">Redirecting to home page in {countdown} seconds...</p>
            </div>
            {data && (
              <div className="text-left bg-muted/30 rounded-lg p-4 space-y-3">
                <h3 className="font-heading text-foreground">Payment Details</h3>
      ...
      case "error":
        return (
          <div className="text-center space-y-6">
            ...
            <div className="space-y-3">
              <h2 className="text-2xl font-heading text-foreground">Payment Verification Failed</h2>
      ...
      default:
        return (
          <div className="text-center space-y-6">
            ...
            <div className="space-y-3">
              <h2 className="text-2xl font-heading text-foreground">Invalid Payment Link</h2>
    ...
    <Card className="w-full max-w-md border-border bg-card shadow-lg">
      <CardContent className="p-8">
        <div className="text-center space-y-6">
          ...
          <div className="space-y-2">
            <h2 className="text-2xl font-heading text-foreground">Loading Payment Status</h2>
